<header class="header js-header" id="header">
    <div class="header__top-bar">
        <a href="#" class="header__logo">
            <img src="assets/svg/West-Hills-College-Coalinga.svg" alt="West Hills College" class="header__logo-image">
        </a>
        ...
        <div class="header__selector" id="site-select" v-on:focusout="checkFocusSelect">
            <button class="header__selector-current" data-icon="mini-nav-drop-down" tabindex="0" v-on:focus="containerFocus" v-on:click="openList" aria-controls="site-select-list">Coalinga</button>
