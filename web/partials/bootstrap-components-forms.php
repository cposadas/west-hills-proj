<h1 class="mt-5" id="forms">::::Forms</h1>
<hr/>
...
<div class="container">
  ...
  <form class="form-inline" role="form">
    ...
    <input type="text" class="form-control mb-2 mr-sm-2" id="email3" placeholder="Enter email">
    <label for="pwd2" class="mb-2 mr-sm-2">Password:</label>
    <input type="text" class="form-control mb-2 mr-sm-2" id="pwd3" placeholder="Enter password">
