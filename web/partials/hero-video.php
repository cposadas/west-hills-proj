<section class="section__container">
    <div class="section__content-full">
        <div class="hero-video__container js-hero-video-container">
          <video class="hero-video__video js-hero-video" muted poster="http://placehold.it/1140x565" src="assets/video/test.mp4" autoplay loop aria-label="background hero video">
