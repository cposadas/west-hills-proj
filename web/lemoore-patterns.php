...
<html class="no-js" lang="EN">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="assets/css/dist/lemoore.min.css">
    </head>
    <body>
        <div class="site js-site" id="site">
            <?php require_once './partials/header-lemoore.php' ?>
            <main class="site__main-content js-main-content">
                <?php
                    ...
                    require_once './partials/options-full-width-combo.php';
            ...
            <?php require_once './partials/footer-lemoore.php' ?>
        </div>
